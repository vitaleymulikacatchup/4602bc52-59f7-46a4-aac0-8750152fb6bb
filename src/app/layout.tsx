...
export const metadata: Metadata = {
  title: "Pelemix - Premium Coconut Coir Substrates for Sustainable Agriculture",
  description: "Leading provider of high-quality coir-based grow bags and substrates for vegetables and plants. Sustainable solutions for growers worldwide.",
  keywords: "coconut coir, agricultural substrates, grow bags, sustainable farming, horticulture, growing medium",
  metadataBase: new URL("https://pelemix.com"),
  alternates: {
    canonical: "https://pelemix.com"
  },
  openGraph: {
    title: "Pelemix - Premium Coconut Coir Substrates",
    description: "High-quality coir-based grow bags and substrates for optimal plant growth and sustainability",
    siteName: "Pelemix",
    images: [{
      url: "https://images.pexels.com/photos/17741703/pexels-photo-17741703.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Pelemix coconut coir substrates"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Pelemix - Sustainable Agriculture Solutions",
    description: "Premium coconut coir substrates for professional growers worldwide",
    images: ["https://images.pexels.com/photos/17741703/pexels-photo-17741703.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
